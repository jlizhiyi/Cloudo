===== C:\Users\Josh\Documents\Cloudo\content\aws-ccp\units\01-cloud-concepts\lessons\01-what-is-cloud\exercises.json =====
[
  {
    "type": "multiple",
...
===== C:\Users\Josh\Documents\Cloudo\content\aws-ccp\units\01-cloud-concepts\lessons\01-what-is-cloud\intro.md =====
...
===== C:\Users\Josh\Documents\Cloudo\content\aws-ccp\units\01-cloud-concepts\lessons\02-cloud-deployment-models\exercises.json =====
[
  {
    "type": "multiple",
...
===== C:\Users\Josh\Documents\Cloudo\content\aws-ccp\units\01-cloud-concepts\lessons\02-cloud-deployment-models\intro.md =====
...
===== C:\Users\Josh\Documents\Cloudo\content\aws-ccp\units\01-cloud-concepts\unit.json =====
{
  "dir": "01-cloud-concepts",
  "title": "Cloud Concepts",
  "lessons": [
    { "slug": "01-what-is-cloud", "title": "What is Cloud Computing?" },
    { "slug": "02-cloud-deployment-models", "title": "Cloud Deployment Models" }
  ]
}

===== C:\Users\Josh\Documents\Cloudo\content\aws-ccp\units\02-core-services\lessons\01-compute-services\exercises.json =====
[
  {
    "type": "multiple",
...
===== C:\Users\Josh\Documents\Cloudo\content\aws-ccp\units\02-core-services\lessons\01-compute-services\intro.md =====
# Compute Services
...
===== C:\Users\Josh\Documents\Cloudo\content\aws-ccp\units\02-core-services\lessons\02-storage-services\exercises.json =====
[
  {
    "type": "multiple",
...
===== C:\Users\Josh\Documents\Cloudo\content\aws-ccp\units\02-core-services\lessons\02-storage-services\intro.md =====
# Storage Services
...
===== C:\Users\Josh\Documents\Cloudo\content\aws-ccp\units\02-core-services\unit.json =====
{
  "dir": "02-core-services",
  "title": "Core Services",
  "lessons": [
    { "slug": "01-compute-services", "title": "Compute Services" },
    { "slug": "02-storage-services", "title": "Storage Services" }
  ]
}

===== C:\Users\Josh\Documents\Cloudo\content\aws-ccp\units\03-security-pricing\lessons\01-shared-responsibility\exercises.json =====
[
  {
    "type": "multiple",
  ...
  {
    "type": "multiple",
    "question": "Who is responsible for Physical security?",
    "options": ["Cloud provider", "Customer", "Both"],
    "correct": 0,
    "explanation": "Physical security of data centers (locks, guards, rack security) is the cloud provider's responsibility."
  },
  {
    "type": "multiple",
    "question": "Who is responsible for Customer data encryption?",
    "options": ["Cloud provider", "Customer"],
    "correct": 1,
    "explanation": "Customers are typically responsible for encrypting their data and managing keys unless using a managed service that opts in on their behalf."
  },
  {
    "type": "multiple",
    "question": "Who is responsible for Network infrastructure?",
    "options": ["Cloud provider", "Customer"],
    "correct": 0,
    "explanation": "The underlying networking hardware and global backbone are the cloud provider's responsibility."
  },
  {
    "type": "multiple",
    "question": "Who is responsible for IAM user permissions?",
    "options": ["Cloud provider", "Customer"],
    "correct": 1,
    "explanation": "Customers configure IAM identities, roles, and permissions for their accounts and workloads."
  },
  {
    "type": "multiple",
    "question": "Who is responsible for security 'of' the cloud (infrastructure)?",
    "options": ["Cloud provider", "Customer"],
    "correct": 0,
    "explanation": "Provider secures the infrastructure (of the cloud): physical hosts, networking, and virtualization layers."
  },
  {
    "type": "multiple",
    "question": "Who is responsible for security 'in' the cloud (your workloads)?",
    "options": ["Cloud provider", "Customer"],
    "correct": 1,
    "explanation": "Customers secure their workloads (in the cloud): apps, data, OS patches, and configuration."
  }
]

===== C:\Users\Josh\Documents\Cloudo\content\aws-ccp\units\03-security-pricing\lessons\01-shared-responsibility\intro.md =====
...
===== C:\Users\Josh\Documents\Cloudo\content\aws-ccp\units\03-security-pricing\lessons\02-cloud-pricing-models\exercises.json =====
[
  {
    "type": "multiple",
...
===== C:\Users\Josh\Documents\Cloudo\content\aws-ccp\units\03-security-pricing\lessons\02-cloud-pricing-models\intro.md =====
...
===== C:\Users\Josh\Documents\Cloudo\content\aws-ccp\units\03-security-pricing\unit.json =====
{
  "dir": "03-security-pricing",
  "title": "Security & Pricing",
  "lessons": [
    { "slug": "01-shared-responsibility", "title": "Shared Responsibility Model" },
    { "slug": "02-cloud-pricing-models", "title": "Cloud Pricing Models" }
  ]
}

===== C:\Users\Josh\Documents\Cloudo\content\aws-ccp\course.json =====
{
  "id": "aws-ccp",
